...
import numpy as np
import torch
from lzero.worker.diamond_evaluator import DiamondEvaluator
...
def eval_diamond(
    ...
    assert create_cfg.policy.type in ['diamond'], "LightZero now only support the following algo.: 'iris'"
